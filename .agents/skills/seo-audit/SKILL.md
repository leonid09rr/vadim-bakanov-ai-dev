...
Read `.agents/skills/_seo-shared/references/framework-detection.md` for detection rules.
...
- Russia → `.agents/skills/_seo-shared/references/locale-ru.md`
- English markets → `.agents/skills/_seo-shared/references/locale-en.md`
- Other → `.agents/skills/_seo-shared/references/locale-generic.md`

## Step 3: Detect MCP Tools

Read `.agents/skills/_seo-shared/references/mcp-integration.md` for tool names.
...
- .agents/skills/seo-audit/references/technical-seo.md
- .agents/skills/seo-audit/references/on-page-seo.md
- .agents/skills/_seo-shared/references/aeo-checklist.md
- .agents/skills/_seo-shared/references/locale-{locale}.md
...
Model: default. Tools: WebFetch, Read, Grep, Glob.
...
Model: default. Tools: WebFetch, Read, Glob.
...
Model: default. Tools: Ahrefs MCP or Semrush MCP tools.
...
Read `.agents/skills/_seo-shared/references/schema-patterns.md` for templates.
